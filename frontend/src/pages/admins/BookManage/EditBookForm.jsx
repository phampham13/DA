...
import { addNewBook, selectBookById, fetchBooks, editBook } from "../../../redux/slides/booksSlice";
                ...
                <div className={cx("form-body")}>
                    <div className={cx("form-group")}>
                        <div className={cx("form-input")}>
                            <label htmlFor="bookId" className={cx("form-label")}>
                                Mã sách<span> *</span>
                            </label>
                            <input id="bookId" name="bookId" type="text" placeholder="Mã sách" value={formik.values.bookId} disabled className={cx("form-control")} />
